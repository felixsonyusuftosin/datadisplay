...
export const Header: React.FC<HeaderProps> = ({ toggleFilter }) => {
  ...
  const handleCustomSelection = () => {
    setFilterVisibilityState({
      matchesLastMonth: false,
      matchesLastYear: false
    })
    toggleFilter()
  }
      ...
      <div className='row heading-row'>
        ...
        <div className='button-row-container'>
          <div className='curved-button-row'>
            <button
              onClick={handleFilterLastMonthChanged}
              className={
                matchesLastMonth ? 'blue white-text' : 'white dark-text'
              }>
              Last Month
            </button>
            <button
              onClick={handleFilterLastYearChanged}
              className={
                matchesLastYear ? 'blue white-text' : 'white dark-text'
              }>
              Last Year
            </button>
            <button className='white dark-text' onClick={handleCustomSelection}>
              {' '}
              Custom
            </button>
          </div>
